...
const TOAST_ICONS = {
  error: (props) => <CircleAlertIcon color="#ef4444" {...props} />, // Example custom red
  info: InfoIcon, // Default (uses Tailwind class text-info)
  loading: LoaderCircleIcon, // Default
  success: (props) => <CircleCheck color="#3cf524" {...props} />, // Your custom green
  warning: (props) => <TriangleAlertIcon color="#f59e0b" {...props} /> // Example custom orange
};
