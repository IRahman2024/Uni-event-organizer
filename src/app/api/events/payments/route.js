...
export async function POST(request) {
    try {
        ...
        const paymentData = {
            ...
            success_url: `http://localhost:3000/api/events/payments/success?paymentId=${paymentEntry.id}`,
            fail_url: `http://localhost:3000/api/events/payments/cancel?paymentId=${paymentEntry.id}`,
            cancel_url: `http://localhost:3000/api/events/payments/cancel?paymentId=${paymentEntry.id}`,
