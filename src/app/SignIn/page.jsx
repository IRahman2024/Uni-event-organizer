'use client'  // Fixed the typo here!
...
export default function Page() {
  ...
  const highway = {
    // Remove the function props if you don't need them, 
    // or define them inline if you do
  ...
  return (
    <div className="relative min-h-screen bg-black w-full overflow-hidden">
      ...
      <div className="absolute inset-0 z-[5] pointer-events-none bg-gradient-to-b from-black/40 via-transparent to-transparent" />
      <div className="relative z-10 flex lg:flex-row flex-col min-h-screen items-center justify-center p-6 md:p-10">
        <BlurText
          text={`Embrace Your Journey!`}
          delay={160}
          animateBy="words"
          direction="top"
          className="text-4xl mb-8 text-white mr-10"
        />
